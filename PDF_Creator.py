...
#    set sínea de la mitad al tamaño normal
    ...
    pdf.cell(ancho_celda2, alto_celda1,str(a['var_L']),0,0)
    ...
    pdf.cell(ancho_celda2, alto_celda1,str(a['var_W']),0,0)
    ...
    pdf.cell(ancho_celda2, alto_celda1,str(a['var_H']),0,0)
    pdf.cell(ancho_celda1,alto_celda1,'Densidad anual equivalente de rayos: ',0,0)
    pdf.cell(ancho_celda2, alto_celda1,str(a['var_DDT']),0,0)
    pdf.ln(alto_celda1)
    pdf.cell(ancho_celda1,alto_celda1,'Área total de la estructura [m]: ',0,0)
    pdf.cell(ancho_celda2, alto_celda1,str(a['var_A_d']),0,0)
    pdf.cell(ancho_celda1,alto_celda1,' ',0,0)
    pdf.cell(ancho_celda2, alto_celda1,'',0,0)
    pdf.ln(alto_celda1)
    ...
    pdf.cell(31.5,alto_celda1,str(a['var_R_d1']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_i1']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_1']),0,0,'C')
    
    pdf.ln(alto_celda1)
    pdf.cell(ancho_celda1,alto_celda1,'Pérdidas de serv. públicos: ',0,0)
    pdf.cell(31.5, alto_celda1,'1.00e-3',0,0,'C')
    pdf.cell(31.5,alto_celda1,str(a['var_R_d2']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_i2']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_2']),0,0,'C')
    pdf.ln(alto_celda1)
    pdf.cell(ancho_celda1,alto_celda1,'Pérdidas de patrimonio: ',0,0)
    pdf.cell(31.5, alto_celda1,'1.00e-3',0,0,'C')
    pdf.cell(31.5,alto_celda1,str(a['var_R_d3']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_d3']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_3']),0,0,'C')
    pdf.ln(alto_celda1)
    pdf.cell(ancho_celda1,alto_celda1,'Pérdidas económicas: ',0,0)
    pdf.cell(31.5, alto_celda1,'1.00e-3',0,0,'C')
    pdf.cell(31.5,alto_celda1,str(a['var_R_d4']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_d4']),0,0,'C')
    pdf.cell(31.5, alto_celda1,str(a['var_R_4']),0,0,'C')
...
# =============================================================================
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_A_d'])+' m2',0,0)


 #  salto línea 
    pdf.ln(alto_celda3)
    pdf.cell(ancho_celda5,alto_celda3,'Nd - número medio de impactos directos a la estructura por año',0,0)
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_N_D'])+' flashes/year',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_A_m'])+' m2',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_N_M'])+' flashes/year',0,0)
    pdf.ln(alto_celda3)
    pdf.cell(ancho_celda4, alto_celda3,'',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_A_c1'])+' m2',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_N_L1'])+' flashes/year',0,0)
    pdf.ln(alto_celda3)
    pdf.cell(ancho_celda4, alto_celda3,'',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_A_c2'])+' m2',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_N_L2'])+' flashes/year',0,0)
    pdf.ln(alto_celda3)
    pdf.cell(ancho_celda4, alto_celda3,'',0,0)   
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_A_l2'])+' m2',0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_N_I2'])+' flashes/year',0,0)
...
# =============================================================================
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_A1']),0,0)
 ...
 #  salto línea  
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_B1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_C1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_M1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_U1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_V1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_W1']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_Z1']),0,0)
...
# =============================================================================
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_B2']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_C2']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_M2']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_V2']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_W2']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_Z2']),0,0)
...
# =============================================================================
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_B3']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_V3']),0,0)
...
# =============================================================================
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_A4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_B4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_C4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_M4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_U4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_V4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_W4']),0,0)
 ...
 #  salto línea 
    ...
    pdf.cell(ancho_celda4, alto_celda3,str(a['var_R_Z4']),0,0)
